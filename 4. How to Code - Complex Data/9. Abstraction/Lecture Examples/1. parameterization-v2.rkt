...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |1. parameterization-v2|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; given a list of numbers n, if (fn n) true, keep them. otherwise remove them
