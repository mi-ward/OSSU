...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |1. parameterization-v3|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; given a list, produce only the elements of that list
...
(check-expect (filter2 string-upper-case? (list "DOG" "dog" "CAT" "cat")) (list "DOG" "CAT"))
