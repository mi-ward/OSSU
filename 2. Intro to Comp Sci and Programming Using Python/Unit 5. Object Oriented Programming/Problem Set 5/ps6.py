...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(len(alpha_upper)):
            shift_dict[alpha_upper[i]] = alpha_upper[(i + shift) % len(alpha_upper)]
        
        for j in range(len(alpha_lower)):
            shift_dict[alpha_lower[j]] = alpha_lower[(j + shift) % len(alpha_lower)]
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for i in range(0, 26):
            ...
            if valid_word_counter > valid_word_max:
                best_guess = (i, message)
                valid_word_counter = valid_word_max
