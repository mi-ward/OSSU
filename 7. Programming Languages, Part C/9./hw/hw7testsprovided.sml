...
in
	if real_equal(a,c) andalso real_equal(b,d)
	then (print "Line - eval_prog with empty environment worked\n")
	else (print "Line - eval_prog with empty environment is not working properly\n")
end;
...
in
	if real_equal(a,c)
	then (print "VLine - eval_prog with empty environment worked\n")
	else (print "VLine - eval_prog with empty environment is not working properly\n")
end;

let 
	val LineSegment(a,b,c,d) = (eval_prog (preprocess_prog (Shift(3.0, 4.0, LineSegment(4.0, 5.0, 6.0, 7.0))), []))
	val LineSegment(e,f,g,h) = LineSegment(7.0, 9.0, 9.0, 11.0) 
in
	if real_equal(a,e) andalso real_equal(b,f) andalso real_equal(c,g) andalso real_equal(d,h)
	then (print "LineSeg - eval_prog with empty environment worked\n")
	else (print "LineSeg - eval_prog with empty environment is not working properly\n")
end;

let 
	val LineSegment(a,b,c,d) = (eval_prog (preprocess_prog (Shift(3.0, 4.0, LineSegment(4.0, 5.0, ~6.0, ~7.0))), []))
	val LineSegment(e,f,g,h) = LineSegment(~3.0, ~3.0, 7.0, 9.0) 
in
	if real_equal(a,e) andalso real_equal(b,f) andalso real_equal(c,g) andalso real_equal(d,h)
	then (print "LineSeg - eval_prog with empty environment worked\n")
	else (print "LineSeg - eval_prog with empty environment is not working properly\n")
