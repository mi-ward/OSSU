...
print(Let.new("x",LineSegment.new(1.0,2.0,1.0,2.0),LineSegment.new(2.0,3.0,1.0,0.0)).preprocess_prog)
print(LineSegment.new(1.0,2.0,1.0,2.0).preprocess_prog)
print(LineSegment.new(2.0,3.0,1.0,0.0).preprocess_prog)
test1 = Shift.new(5,5,Point.new(5,5)).eval_prog([])
print(test1.x)
print(test1.y)
