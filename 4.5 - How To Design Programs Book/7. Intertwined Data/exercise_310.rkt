...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise_310) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;Exercise 310
;Develop count-persons.
;The function consumes a family tree
