...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise_392) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (tree-pick TOS LOD)
  (cond
    ...
    [(or (and (cons? LOD) (symbol? TOS))
         (and (empty? LOD) (branch? TOS))) (error "error")]
    [(string=?  "left" (first LOD)) (tree-pick (branch-left TOS) (rest LOD))]
    [(string=? "right" (first LOD)) (tree-pick (branch-right TOS) (rest LOD))]))
