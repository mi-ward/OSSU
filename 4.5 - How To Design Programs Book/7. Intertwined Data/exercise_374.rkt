...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise_374) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (render-item item)
  (local [(define content (first (xexpr-content item)))]
    (bulletize 
     (cond [(word? content)
            (text (word-text content) 12 'white)]
