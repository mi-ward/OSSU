...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise_406) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;Exercise 406.
; The row-project function recomputes the labels for every row of the database’s content.
; Does the result differ from function call to function call? No
