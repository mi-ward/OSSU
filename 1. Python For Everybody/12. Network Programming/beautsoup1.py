...
#Actual data: http: // py4e-data.dr-chuck.net/comments_1812686.html(Sum ends with 0)
...
req = urllib.request.urlopen('http://py4e-data.dr-chuck.net/comments_1819551.html').read()
soup = BeautifulSoup(req.decode(), 'html.parser')
num_list = list()

for span in soup.find_all('span'):
    comment_count = int(span.contents[0])
    num_list.append(comment_count)
