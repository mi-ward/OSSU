...
# (i.e. domain name of the email address) using a 
...
# If you run the program multiple times in testing or 
# with different files, make sure to empty out the data before each run.

# You can use this code as a starting point 
# for your application: http://www.py4e.com/code3/emaildb.py.

# The data file for this application is the 
# same as in previous assignments: http://www.py4e.com/code3/mbox.txt.

# Because the sample code is using an UPDATE statement and 
# committing the results to the database as each record is read in the loop, it might take as long as a few minutes to process all the data. The commit insists on completely writing all the data to disk every time it is called.
...
# between the number of operations you execute between 
# commits and the importance of not losing the results of 
