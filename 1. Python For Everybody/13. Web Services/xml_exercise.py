...
# One is a sample file where we give you the 
# sum for your testing and the other is the actual data you need to process for the assignment.

# Sample data: http: // py4e-data.dr-chuck.net/comments_42.xml(Sum=2553)
# Actual data: http: // py4e-data.dr-chuck.net/comments_1812688.xml(Sum ends with 68)
...
# than the data we are parsing in that sample code
...
# You could also work from the top of the XML 
# down to the comments node and then 
...
sample_url = 'http://py4e-data.dr-chuck.net/comments_42.xml' #(Sum=2553)
actual_url = 'http://py4e-data.dr-chuck.net/comments_1819553.xml' #(Sum ends with 68)
total = 0 
